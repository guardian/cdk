...
describe("The GuDatabaseInstance class", () => {
  ...
  it("sets the parameter group if passed in", () => {
    ...
    Template.fromStack(stack).hasResourceProperties("AWS::RDS::DBInstance", {
      DBParameterGroupName: {
        Ref: Match.stringLikeRegexp("MyParameterGroup*"),
      },
    });
  });
  ...
  it("creates a new parameter group if parameters are passed in", () => {
    ...
    template.hasResourceProperties("AWS::RDS::DBInstance", {
      DBParameterGroupName: {
        Ref: Match.stringLikeRegexp("DatabaseInstanceTestingParameterGroup*"),
      },
    });
    ...
    new GuTemplate(stack).hasGuTaggedResource("AWS::RDS::DBParameterGroup", {
  ...
  it("overrides the logicalId when existingLogicalId is set in a migrating stack", () => {
    ...
    new GuTemplate(stack).hasResourceWithLogicalId("AWS::RDS::DBInstance", "MyDb");
  });
