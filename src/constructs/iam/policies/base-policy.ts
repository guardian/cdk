...
export class GuPolicy extends Policy {
  constructor(scope: GuApp, id: string, props: GuPolicyProps) {
...
export class GuAllowPolicy extends GuPolicy {
  constructor(scope: GuApp, id: string, props: GuAllowPolicyProps) {
    super(scope, id, props);
...
export class GuDenyPolicy extends GuPolicy {
  constructor(scope: GuApp, id: string, props: GuDenyPolicyProps) {
    super(scope, id, props);
