 ...
 *
 * In order to inherit an existing Application Load Balancer, pass the logical id from your CloudFormation template to this construct via the `existingLogicalId` prop.
 */
export class GuApplicationLoadBalancer extends WithStaticLogicalId(GuAppAwareConstruct(ApplicationLoadBalancer)) {
