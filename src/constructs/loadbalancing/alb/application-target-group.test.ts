...
describe("The GuApplicationTargetGroup class", () => {
  ...
  it("should apply the App tag", () => {
    ...
    new GuTemplate(stack).hasGuTaggedResource("AWS::ElasticLoadBalancingV2::TargetGroup", {
      appIdentity: app,
    });
  });
  ...
  test("overrides the logicalId when existingLogicalId is set in a migrating stack", () => {
    ...
    new GuTemplate(stack).hasResourceWithLogicalId("AWS::ElasticLoadBalancingV2::TargetGroup", "MyTargetGroup");
  });
