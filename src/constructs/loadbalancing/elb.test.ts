...
describe("The GuClassicLoadBalancer class", () => {
  ...
  test("overrides the logicalId when existingLogicalId is set in a migrating stack", () => {
    ...
    new GuTemplate(stack).hasResourceWithLogicalId("AWS::ElasticLoadBalancing::LoadBalancer", "MyCLB");
  });
  ...
  test("applies the App tag", () => {
    ...
    new GuTemplate(stack).hasGuTaggedResource("AWS::ElasticLoadBalancing::LoadBalancer", {
